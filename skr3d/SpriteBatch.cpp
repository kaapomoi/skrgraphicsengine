...
namespace skrengine
{
	SpriteBatch::SpriteBatch()
		: _vao(0), _vbo(0), _sortType(GlyphSortType::TEXTURE)
	{
	}
	...
	void SpriteBatch::sortGlyphs()
	{
		switch (_sortType)
		{
		case skrengine::GlyphSortType::NONE:
			//dont sort
			break;
		case skrengine::GlyphSortType::FRONT_TO_BACK:
			...
			break;
		case skrengine::GlyphSortType::BACK_TO_FRONT:
			std::stable_sort(_glyphs.begin(), _glyphs.end(),
				[](const Glyph* a, const Glyph* b) -> bool
				{
					return a->depth > b->depth;
			...
			break;
		case skrengine::GlyphSortType::TEXTURE:
			std::stable_sort(_glyphs.begin(), _glyphs.end(),
				[](const Glyph* a, const Glyph* b) -> bool
				{
